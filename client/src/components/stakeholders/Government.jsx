...
const Government = () => {
  ...
  return (
    <div className="text-black p-12">
      <h1 className="text-5xl font-bold mb-4">Welcome Government!!</h1>
      <div className="mb-6 text-2xl pt-8">What would you like to do?</div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div  onClick={handleRegisterClick} className="cursor-pointer bg-white p-6 rounded-lg shadow-md flex flex-col justify-center h-80">
                <h2 className="text-xl font-bold mb-2 h-32 p-11 text-white bg-sky-700 text-center">Register Stakeholders</h2>
