...
const Sell = () => {
        ...
        return (
        <div>
                        <h1 className='text-5xl font-bold text-blue-500 mt-16 mb-16'>Sell Medicine</h1>
                ...
                <button className='bg-blue-500 text-white px-6 py-3 rounded-md mt-8 hover:bg-blue-600 text-3xl' onClick={handlerSellMedicine}>Sell</button>      
